...
```bash
git clone https://github.com/<USERNAME>/freezly.git
cd freezly
git remote add upstream https://github.com/dogma-io/freezly.git
```

**SSH**

```bash
git clone git@github.com:<USERNAME>/freezly.git
cd freezly
git remote add upstream git@github.com:dogma-io/freezly.git
```
...
[fork-repo]: https://github.com/dogma-io/freezly#fork-destination-box
